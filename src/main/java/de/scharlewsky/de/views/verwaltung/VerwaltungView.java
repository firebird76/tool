package de.scharlewsky.de.views.verwaltung;
...
import de.scharlewsky.de.data.entity.SamplePerson;
import de.scharlewsky.de.data.service.SamplePersonService;
import de.scharlewsky.de.views.MainLayout;
...
@PermitAll
@Uses(Icon.class)
public class VerwaltungView extends Div {
    ...
    public VerwaltungView(SamplePersonService SamplePersonService) {
